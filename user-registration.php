...
if (! empty($_POST["signup-btn"])) {
	...
	if($exist){
		...
		$query2 = mysqli_query($con ,"insert into user values(null, '$name' , '$email','$password' ,$phone ,$age)");
    ...
    ?>
				...
				<div class="error-msg" id="error-msg"></div>
					...
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Phone<span class="required error" id="phone-info"></span>
							</div>
					...
					<div class="row">
						<div class="inline-block">
							...
							<input class="input-box-330" type="age" name="age" id="age">
						</div>
					</div>
